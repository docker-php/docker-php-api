...
class Client extends \Jane\OpenApiRuntime\Client\Psr7HttplugClient
{
    ...
    {
        return $this->executePsr7Endpoint(new \Docker\API\Endpoint\ContainerWait($id), $fetch);
    }
    ...
    {
        return $this->executePsr7Endpoint(new \Docker\API\Endpoint\ContainerGetArchive($id, $queryParameters), $fetch);
    }
    ...
    {
        return $this->executePsr7Endpoint(new \Docker\API\Endpoint\ContainerArchiveHead($id, $queryParameters), $fetch);
    }
    ...
    {
        return $this->executePsr7Endpoint(new \Docker\API\Endpoint\ContainerPutArchive($id, $inputStream, $queryParameters), $fetch);
    }
     ...
     *
     * @return null|\Docker\API\Model\ImageDeleteResponse[]|\Psr\Http\Message\ResponseInterface
     */
     ...
     *
     * @return null|\Docker\API\Model\InfoGetResponse200|\Psr\Http\Message\ResponseInterface
     */
    ...
    {
        return $this->executePsr7Endpoint(new \Docker\API\Endpoint\NetworkInspect($id), $fetch);
    }
    ...
    {
        return $this->executePsr7Endpoint(new \Docker\API\Endpoint\PluginList(), $fetch);
    }
     ...
     *
     * @return null|\Docker\API\Model\SwarmGetResponse200|\Psr\Http\Message\ResponseInterface
     */
    ...
    {
        return $this->executePsr7Endpoint(new \Docker\API\Endpoint\ServiceInspect($id), $fetch);
    }
